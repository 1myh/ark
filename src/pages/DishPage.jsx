	...
	return (
		<div className={`flex flex-col items-center`} >
			...
			<div className={`flex flex-col md:flex-row justify-center items-center md:items-start w-full`} >
				<div className={`flex order-2 md:or() => setCartCounter(cartCounter + 1der-1 flex-col max-w-[30rem] md:w-fit w-full px-10 py-5 my-5 items-end`} >
					...
					<button onClick={handle} className={`lg:text-xl my-5 p-3 text-white bg-dish w-fit rounded-lg`} >اضافة الى الطلبية</button>
				</div>
